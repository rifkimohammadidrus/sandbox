		...
		<div id="mobile" class="container clearfix" style="background-color:#fff; border-radius:8px">
			...
			<div class="row">
				<div class="col" >
					<div id="indikator" class="carousel slide" data-ride="carousel" data-interval="false">
						...
						<ol class="carousel-indicators ">
							<?php if ($image1!=''){?>
								<li data-target="#indikator" data-slide-to="0" class="active"><img src="assets/foto_produk/<?= $image1 ?>"></li>
							<?php }

							if ($image2!=''){?>
								<li data-target="#indikator" data-slide-to="1" class="active"><img src="assets/foto_produk/<?= $image2 ?>"></li>
							<?php }
							if ($image3!=''){?>
								<li data-target="#indikator" data-slide-to="2"><img src="assets/foto_produk/<?= $image3 ?>"></li>
							<?php }
							if ($image4!=''){?>
								<li data-target="#indikator" data-slide-to="3"><img src="assets/foto_produk/<?= $image4 ?>"></li>
							<?php }?>
				...
				<div id="mob-produk" class="col mt-3">
					<h3 class="margin0" style="font-size: 20px"><?= $name ?></h3>
					<!-- <p class="margin0 hilang">Terjual 500++</p> -->
					...
					<button type="button" class="btn btn-outline-secondary tebal" onclick="masukanKeranjang('<?php echo $idb?>','<?php echo $id_outlet;?>')"><i class="icon-shopping-cart"></i> Masukan Keranjang</button> &emsp;
				...
				<div class="modal-body">
					...
					<form method="post" id="formPesanLangsung">
						...
						<div class="form-group mt-1">
							...
							<input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="0812xxxx">
						</div>
						<div class="form-group">
							<label class="label" for="FormControlInput1">Nama Lengkap</label>
							<input type="text" class="form-control cekout" id="nama" name="nama" placeholder="Nama Lengkap Pemesan">
						</div>
