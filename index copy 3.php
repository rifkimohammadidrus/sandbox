...
if ($kategori=='all') {
  ...
  $terlaris=""; $garis_terlaris="";
  $terbaru=""; $garis_terbaru="";
  $promo=""; $garis_promo=""; 
  $judul=$kategori;
...
// $sql="SELECT SQL_CALC_FOUND_ROWS
// jb.kode_jenis,jb.nama,jb.gambar1,mb.id_outlet, o.alias ,tdi.barcode  
// FROM master_barang AS mb  INNER JOIN  jenis_barang as jb ON (jb.kode_jenis = mb.kode_jenis)
//               INNER JOIN  outlet as o ON (o.id=mb.id_outlet) 
//                           LEFT join kategori as k on (k.kode_kategori=jb.kode_kategori)
//                           LEFT join tbl_disc_item as tdi on tdi.barcode=jb.kode_jenis
//  WHERE jb.status=1 $filter_kategori 
//  GROUP BY jb.kode_jenis,mb.id_outlet  HAVING SUM(mb.stok>0)
// ORDER BY mb.disc,tdi.barcode DESC";
          ...
          $harga_diskon=$hargabarang-$nilai_diskon; 
           ...
           ?>
            ...
            <div class="col pt-2 text-center" style="">
              ...
              <!-- <a href="detail_produk.php?name=<?php echo $nama_toko ?>&produk=<?php echo $nama_url?>&otl=<?php echo $outlet; ?>"> -->
              <!-- <a href="detail-<?php echo $nama_toko ?>-<?php echo $nama_url?>-<?php echo $outlet; ?>"> -->
              ...
              <div class="card"> 
                ...
                <div class="card-footer">
                  ...
                  <?php if ($disc_value!=0) {
                  ?>
                    <p class="harga-promo text-left"><span><?php echo $disc_value ?></span> <del style="text-decoration: line-through;"><?php echo "Rp. ". number_format("$hargabarang",0,",","."); ?></del></p>
                  <?php
                  } ?>
                </div>
                <!-- /<div class="card-footer"> -->
...
<?php include("template/footer.php"); } } else{
  echo "<script>window.location.href='sigin_admin.php'</script>";
} ?>
