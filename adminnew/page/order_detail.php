                                ...
                                <script>
                                 ...
                                 function export_exel(){
                                  ...
                                  {  
                                    ...
                                    <td align="center"><?php echo round($persentase_disc,2).' %'; ?></td>
	...
	<div class="modal fade" id="confirm<?= $no_transaksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <form  method="post" id="confirm">
				  <div class="modal-body">
						...
						<div style="margin:10px">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="ongkir" name="ongkir" placeholder="Ongkos Kirim" onkeyup='hitung_sub()' autocomplete="off">
							</div>
							<div class="form-group">
              ...
              <input type="hidden" class="form-control" name="id_pesanbayar" value="<?= $pesanbayar ?>">
	...
	<div class="modal fade" id="approve<?= $no_transaksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <form  method="post" id="approve">
            ...
            <h4>Apakah Anda yakin Approve pesanan ini?</h4>
						<?php 
            $sql="SELECT SUBSTRING(id_barang,1,7), qty FROM pesan_detail where no_transaksi='$no_transaksi' ";
            // $sql="SELECT id_barang, qty FROM pesan_detail where no_transaksi='$no_transaksi' ";
            $query=mysqli_query($connect, $sql)or die($sql);
    
            while(list($barcode, $qty)=mysqli_fetch_array($query))
            { ?>
            ...
            ?>
              ...
              <input type="hidden" class="form-control" id="outlet" name="outlet" value="<?= $outlet ?>">
              <input type="hidden" class="form-control" id="no_transaksi" name="no_transaksi" value="<?= $no_transaksi ?>">
              <input type="hidden" class="form-control" name="no_penerima" value="<?= $no_hp ?>">
              <input type="hidden" class="form-control" name="id_pesanbayar" value="<?= $pesanbayar ?>">
