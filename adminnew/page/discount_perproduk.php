...
$sql="SELECT SQL_CALC_FOUND_ROWS tdi.barcode, jb.nama, tdi.status
      FROM  tbl_disc_detail AS tdi INNER JOIN jenis_barang AS jb ON (SUBSTRING(tdi.barcode,1,7) = jb.kode_jenis)
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-responsive table-bordered" style="width:50%;" >
                                      ...
                                      <?php $i=0;
                                      while(list($barcode,$nama,$status)=mysqli_fetch_array($query))  {
                                      $i++;
                                      ?>  
                                      <tr>
                                        <td><?php echo $i;?></td>
