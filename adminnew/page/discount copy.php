                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <a href="disc_tambah.php"><input type="button" class="btn btn-success" value="Tambah"></a><br><br>
                                    ...
                                    <tr class="bg-success">
                                        ...
                                        <td align="center"><strong>Outlet list</strong></td>
                                        <td align="center"  colspan="2"><strong>Aksi</strong></td>
                                    </tr>

                                    <?php $sql="select id,disc_value,start,end,status,item_disc,outlet from tbl_disc where outlet='$_SESSION[id_outlet]' order by start DESC"; 
                                    $query=mysqli_query($connect, $sql)or die($sql);
                                    while(list($id,$value,$startdate,$enddate,$status,$item_disc,$outlet_list)=mysqli_fetch_array($query)){
                                        if ($status==1){
                                        $status='aktif';
                                        } else {
                                        $status='tidak aktif';
                                        ...
                                        <tr class="isi-tabel" height="25">
                                            ...
                                            <td align="center" class="link-isi"><a href="index.php?menu=disc_edit&kode=<?php echo $id?>">Sett Alldisc</a></td>
