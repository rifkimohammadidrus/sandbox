                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>Master size marketplace rabbani</span>
                            </li>
                        </ul>
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content" style="width: 60%;">
                                        ...
                                        <tbody>
                                        <?php $i=0;
                                        $sql="SELECT kode_ukuran,ukuran,ket FROM ukuran";
                                        $query=mysqli_query($connect, $sql) or die($sql);
                                        while (list($kode,$ukuran,$ket)=mysqli_fetch_array($query)){
                                        $i++;
                                        ?>
                                            <tr>
                                               <td><?php echo $i ?></td>
