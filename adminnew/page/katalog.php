                                ...
                                <div class="portlet-body" id="main">
                                         ...
                                         <h3 class="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          ...
                                          <div class="m-grid m-grid-responsive-md m-grid-demo">
                                           <div class="col-sm-12">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="page/katalog_tambah.php" data-target="#ajax-entry" 
                                            data-toggle="modal"> 
                                           ...
                                           <div class="col-sm-12">
		                                    ...
		                                    $sql="SELECT SQL_CALC_FOUND_ROWS
											      k.id,k.kategori,sk.sub_kategori,g.name,k.nama,k.file,k.status,
												  k.status_info,k.updatedate
                                                  FROM tbl_kitalog AS k INNER JOIN tbl_categories AS g ON 
												  (k.kategori=g.id)
                                                  LEFT JOIN tbl_subkategori AS sk ON (sk.id=k.sub_kategori) 
												  $tambahan
                                                  ORDER BY k.id DESC LIMIT ".($page*$jmlHal).",".$jmlHal;
											...
											while(list($idx,$kat,$subkat,$name,$nama,$image,$status,$statusinfo,
											$updatedate)= mysqli_fetch_array($query)){
												
												
												?>   
                                                    <div class="col-sm-3" 
                                                    style="padding: 15px; height: 430px; width:250px;">
                                                        <div class="m-grid m-grid-full-height">
                                                            <div class="m-grid-col m-grid-col-bottom m-grid-col-center 
                                                            bg-light font-green" style="padding: 10px;">
                                  ...
                                  <!--           <img src="../<?php echo $image; ?>" class="img-responsive blog-img-thumb"/>  -->
                                           ...
                                           data-original="../<?php echo $image; ?>"/>
                                              <br />
                                             <a href="#ajax" data-id="<?php echo $idx;?>" data-toggle="modal" style="text-decoration:none;">
