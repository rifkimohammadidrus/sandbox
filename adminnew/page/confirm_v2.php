...
if ($tanda=='confirm') {
  ...
  $total_transfer=$total_belanja+$kd_unik;

  $sql_pb="INSERT INTO `pesan_bayar`(`id_bayar`, `jenis_bayar`, `tanggal`, `total_belanja`, `total_ongkir`, `amount`, `angka_unik`, `total_transfer`,`id_customer`, `status`, `is_batal`,`rekening`,`nama_rekening`) VALUES ('$id_pesanbayar',0,now(),'$total_harga1','$ongkir','$total_belanja','$kd_unik','$total_transfer','$no_penerima',0,0)";
