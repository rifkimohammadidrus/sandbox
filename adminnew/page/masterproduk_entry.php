...
?>
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                      ...
                                      <div id="main_table">
                                          ...
                                          $sql="SELECT s.tgl,m.id_barang, j.nama,u.ket_baru,w.warna, m.harga,m.stok,(m.harga*m.stok) 
                                                FROM master_barang AS m 
                                                LEFT JOIN jenis_barang AS j ON (j.kode_jenis=m.kode_jenis)  
                                        ...
                                        <table class="table table-responsive table-bordered table-striped" style="width:80%;">
                                          ...
                                          <tr class="text-edit" style="height:25">
                                            ...
                                            ondblclick="tampil_edit('<?php echo $barcode?>','<?php echo $no;?>','<?php echo $stok;?>','<?php echo $tgl;?>','<?php echo $outlet;?>')">
                                            <?php echo $stok;?></td>
            ...
            <script src="jquery-3.1.1.min.js"></script>
               <script>
                                             ...
                                             var outlet=$.trim($("#outlet").val()); 
                                               ...
                                               $.ajax({
                                                 ...
                                                 if (data.trim()=='model kosong'){
                                                   ...
                                                   // location.reload();
                                                   $("#barcode_stok").val(''); 
                                                   $("#main_table").load("masterproduk_entry_load.php?outlet="+data[6]+"&time="+data[7]);
                                                   }
                                                 }// END SUCSESS
                                               }); // end ajax
                                           }
                                    ...
                                    function tampil_edit(barcode,no,qty,tgl,otl){
                                      ...
                                      $("#qty_"+no).keydown(function(event){ 
                                        ...
                                        // alert(qty_update);
                                           $.ajax({
                                                 ...
                                                 cache: false,
                                                 dataType:'text',
                                                 data:{b:barcode,q:qty_update,t:tgl, o:otl},
                                                 success: function(data) {
                                                  if (data.trim()=='sukses'){
                                                  $("#main_table").load("masterproduk_entry_load.php?outlet="+otl);
                                                  }
                                                  }// END SUCSESS
                                               }); // end ajax 
                                         } // end event
