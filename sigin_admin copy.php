...
<div class="container login-form">
    ...
    <div class="row py-5 align-items-center">
        ...
        <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
            <img src="assets/images/login.png" alt="" class="img-fluid mb-3 d-none d-md-block">
        ...
        <div class="col-md-7 col-lg-6 ml-auto">
            <p style="color:red; margin-top:-20px; margin-bottom:30px">SILAHKAN LOGIN MENGGUNAKAN AKUN RPOS ANDA</p>
